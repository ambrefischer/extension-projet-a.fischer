...
public class ClickedButtonONOFF /** extends ClickedButton */
{
    ...
    // @Override
    /**
     * public void actionPerformed(ActionEvent e) { System.out.println(nameSat + ":"
     * + nameSS + ":" + message);
     * 
     * // fait appel au model pour exécuter la commande model.doTM(nameSat, nameSS,
     * message);
     * 
     * // si la commande est valide alors on met le nom du sous-système en vert //
     * et on ajoute la commande dans la console de sortie if
     * (model.getStatusCommand()) { label.setForeground(Color.GREEN);
     * appendToPane(textPane, nameSat + ":" + nameSS + ":" + message + "\n",
     * Color.GREEN); } // sinon en rouge else { label.setForeground(Color.RED);
     * appendToPane(textPane, nameSat + ":" + nameSS + ":" + message + "\n",
     * Color.RED); }
     * 
     * switch (message) { // si le bouton ON est clické alors seulenemnt lui
     * apparaît en bleu case "ON": button_ON.setForeground(Color.BLUE);
     * button_OFF.setForeground(Color.BLACK); break;
     * 
     * // si le bouton OFF est clické alors seulenemnt lui apparaît en bleu case
     * "OFF": button_OFF.setForeground(Color.BLUE);
     * button_ON.setForeground(Color.BLACK); break;
     * 
     * default: break; } }
     */
